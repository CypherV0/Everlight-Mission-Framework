...
//Released		: 12/08/2014
//
//Description 	: Displays platoon members (with the possibility to include/exclude IA and the possibility to rename groups) in the diary
//
...
_role 		= false;//true->display unit's role		false->hide unit's role
...
player createDiarySubject ["roster","Everlight Platoon"];
