...
tooltip = "Rangers ACH with SCAR by Cypher";

class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
    uniform[] = {"MNP_CombatUniform_Ranger_A", "MNP_CombatUniform_Ranger_B"};
    vest[] = {};
    headgear[] = {};
    backpack[] = {};
    goggles[] = {"default"};
...
class r : baseMan
{
    ...
    sidearmWeapon[] = {};
    magazines[] = {
        LIST_7("rhs_mag_20Rnd_SCAR_762x51_m80_ball_bk"),
        LIST_3("rhs_mag_20Rnd_SCAR_762x51_m62_tracer_bk"),
        LIST_2("rhs_mag_m67"),
        LIST_2("SmokeShell")
    };
    items[] = {
...
class rat : r
{
    ...
    backpackItems[] =
    {
        LIST_5("rhs_mag_20Rnd_SCAR_762x51_m80_ball_bk")
    };
